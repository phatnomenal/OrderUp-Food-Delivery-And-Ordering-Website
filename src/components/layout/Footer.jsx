    ...
    <footer className="bg-gray-900 text-white py-12 mt-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Chính sách hoàn tiền</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Quy định giao hàng</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-2">
                <img src="https://placehold.co/40x25/ffffff/000000?text=VISA" alt="Visa" className="h-6 rounded" />
                <img src="https://placehold.co/40x25/ffffff/000000?text=MC" alt="Mastercard" className="h-6 rounded" />
                <img src="https://placehold.co/40x25/ffffff/000000?text=MOMO" alt="MoMo" className="h-6 rounded" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 FoodOrder. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
